 ...
 * 日期时间轴格式化工具类
 */
public class TimeLineDateFormat {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Date date1 = format.parse("2016-03-15 20:14:00");
        System.out.println(format(date1));

        Date date2 = format.parse("2016-03-14 20:14:00");
        System.out.println(format(date2));

        Date date3 = format.parse("2016-02-12 20:14:00");
        System.out.println(format(date3));

        Date date4 = format.parse("2012-02-12 20:14:00");
